...
function ViewEventBanner() {
    ...
    const getDetails = async () => {
        const response = await AuthApi.GetMethod('/get-events-banner');
                        ...
                        <SoftBox mb={3}>
                            <Card>
                                <SoftBox
                                    ...
                                    p={3}
                                >
                                    <SoftTypography variant="h6">Even Banner</SoftTypography>
                                        ...
                                        <table id="example" className="table table-striped table-bordered " style={{ width: "100%", fontSize: "14px", alignItems: "center" }}>
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th className="text-center">Banner URL</th>
                                            ...
                                            <tbody>
                                                ...
                                                {data.map((result, index) => {
                                                    return (<tr key={index}>
                                                        ...
                                                        <td>     <Link to={'/update-event-banner/' + result.id}>
