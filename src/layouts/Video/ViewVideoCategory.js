                ...
                <SoftBox mb={3}>
                    <Card>
                        <SoftBox
                            ...
                            p={3}
                        >
                            <SoftTypography variant="h6">Video category</SoftTypography>
                            <Link to={"/create-video-category"}>
                                {" "}
                                <SoftButton
                                    ...
                                    <tbody>
                                        ...
                                        {category.map((result, index) => {
                                            return (<tr key={index}>
                                                ...
                                                <td>     <Link to={'/update-video-category/' + result.id}>
...
export default ViewVideoCategory;
